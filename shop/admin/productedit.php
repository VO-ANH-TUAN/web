...
<div class="grid_10">
    <div class="box round first grid">
        ...
        <div class="block">    
                ...
                ?> 
                <?php 
                $get_prouduct_name=$pd->getproductbyId($id);
                if($get_prouduct_name){
                    while($result_product=$get_prouduct_name->fetch_assoc()){
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <img src="uploads/<?php echo $result_product['image'] ?>" style="width: 50px;" >
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            ...
                            <option selectedvalue="0">Non-Featured</option>
                            <?php 
                            }else{
                            ?>                          
