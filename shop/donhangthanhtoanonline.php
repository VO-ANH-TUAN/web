    	...
    	<div class="cartoption">		
			<div class="cartpage">
               ...
               ?>
    			...
    			<button class="btn_thanhtoan" name="redirect" id="redirect" style="height:40px;width: 100px;color: white;background: green;text-align: center; margin-left: 50%;" >Thanh toán VNPAY</button>
    		</form> 
			    <?php 
			     }
			    ?>
			    ...
			    ?>
			    <a href="cart.php">Quay về giỏ hàng</a>
			<?php 
		}
			?>
